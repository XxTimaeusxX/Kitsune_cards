...
public class CardData : ScriptableObject
{
    ...
    public List<ManaCostandEffect> FireAbilities = new List<ManaCostandEffect>
    {
        ...
        new ManaCostandEffect { ManaCost = 5,Type = AbilityType.Damage, EffectDescription = "Deal 12 damage" },
    ...
    public List<ManaCostandEffect> AirAbilities = new List<ManaCostandEffect>
    {
        ...
        new ManaCostandEffect { ManaCost = 10,Type = AbilityType.Block, EffectDescription = "apply 24 block and reflect 50% of damage taken for 1 turn." },
    };
